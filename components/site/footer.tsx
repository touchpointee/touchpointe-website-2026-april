    ...
    <footer className="border-t border-slate-200 bg-[#1A1A1A]">
      <div className="max-w-7xl mx-auto px-6 py-14 grid gap-10 lg:grid-cols-[1.4fr_0.6fr_0.6fr_0.6fr]">
        <div className="space-y-4 max-w-xs">
          ...
          <a href={siteConfig.links.linkedin} target="_blank" rel="noreferrer noopener" aria-label="Touchpointe on LinkedIn"
            ...
            <a href={siteConfig.links.whatsapp} target="_blank" rel="noreferrer noopener" aria-label="Chat with Touchpointe on WhatsApp"
              className="w-9 h-9 flex items-center justify-center rounded-lg border border-white/10 text-slate-400 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all">
              <WhatsAppIcon />
            </a>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid gap-2">
            ...
            <Link href="/careers" className="text-sm text-slate-400 hover:text-white transition-colors">Careers</Link>
          </div>
        </div>
      </div>
